...
function DashboardPage() {
  ...
  return (
    <div>
      <h1 className="text-xl md:text-2xl font-semibold text-gray-800 mb-6">Dashboard</h1>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  {stats.loading && (stat.label === "Total Users" || stat.label === "Active Users") ? (
                    ...
                    <p className="text-xl md:text-2xl font-semibold text-gray-800">{stat.value}</p>
                  )}
                </div>
              </div>
